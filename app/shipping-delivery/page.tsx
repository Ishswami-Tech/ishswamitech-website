...
import { legalContacts, shippingSections } from "@/lib/legal/policy-content";
      ...
      <section className="page-hero page-hero--compact">
        <div className="container mx-auto max-w-4xl px-4">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }}>
            ...
            <h1 className="type-page-title mb-3 text-[var(--foreground)]">Shipping & Delivery Policy</h1>
            ...
            <p className="type-body mt-4 leading-relaxed text-[var(--text-muted)]">
              This policy explains how Ishswami Tech handles digital service delivery and booking confirmations. We do not ship physical goods as part of our standard business model.
            </p>
          </motion.div>
        </div>
      </section>
